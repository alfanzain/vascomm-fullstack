<div class="mb-[32px]">
    <h2 class="font-serif text-2xl font-bold mb-[33px]">Terbaru</h2>

    <div class="latest-product-showcase grid grid-cols-5 gap-4">
    </div>
</div>

@push('scripts')
<script>
    fetch('/api/v1/products?take=5&skip=0&order=latest', {
        method: 'GET',
        headers: {
        ...
        .then(async (response) => {
            ...
            const productList = document.querySelector('.latest-product-showcase');
